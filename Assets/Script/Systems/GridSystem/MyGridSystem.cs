...
public class MyGridSystem : MvcBehaviour
{
    ...
    private void CreateOutSideCenter()
    {
        ...
        GameObject up = Instantiate(factory.outSides[FloorContainer.OutsideEnum.CenterUp], viewMap);
        up.transform.position = GetWorldPosition(width / 2, height);

        GameObject down = Instantiate(factory.outSides[FloorContainer.OutsideEnum.CenterDown], viewMap);
        down.transform.position = GetWorldPosition(width / 2, -2);

        GameObject left = Instantiate(factory.outSides[FloorContainer.OutsideEnum.CenterLeft], viewMap);
        left.transform.position = GetWorldPosition(-2, height / 2);

        GameObject right = Instantiate(factory.outSides[FloorContainer.OutsideEnum.CenterRight], viewMap);
    ...
    private void CreateOutSideCorner()
    {
        ...
        GameObject upRight1 = Instantiate(factory.outSides[FloorContainer.OutsideEnum.UpRight1], viewMap);
        upRight1.transform.position = GetWorldPosition(width, height);

        GameObject upRight2 = Instantiate(factory.outSides[FloorContainer.OutsideEnum.UpRight2], viewMap);
        upRight2.transform.position = GetWorldPosition(width - 2, height);

        GameObject upRight3 = Instantiate(factory.outSides[FloorContainer.OutsideEnum.UpRight3], viewMap);
        upRight3.transform.position = GetWorldPosition(width, height - 2);

        // UpLeft

        GameObject upLeft1 = Instantiate(factory.outSides[FloorContainer.OutsideEnum.UpLeft1], viewMap);
        upLeft1.transform.position = GetWorldPosition(-2, height);

        GameObject upLeft2 = Instantiate(factory.outSides[FloorContainer.OutsideEnum.UpLeft2], viewMap);
        upLeft2.transform.position = GetWorldPosition(0, height);

        GameObject upLeft3 = Instantiate(factory.outSides[FloorContainer.OutsideEnum.UpLeft3], viewMap);
        upLeft3.transform.position = GetWorldPosition(-2, height - 2);

        // DownRight

        GameObject downRight1 =
            Instantiate(factory.outSides[FloorContainer.OutsideEnum.DownRight1], viewMap);
        downRight1.transform.position = GetWorldPosition(width, -2);

        GameObject downRight2 =
            Instantiate(factory.outSides[FloorContainer.OutsideEnum.DownRight2], viewMap);
        downRight2.transform.position = GetWorldPosition(width - 2, -2);

        GameObject downRight3 =
            Instantiate(factory.outSides[FloorContainer.OutsideEnum.DownRight3], viewMap);
        downRight3.transform.position = GetWorldPosition(width, 0);

        // DownLeft

        GameObject downLeft1 =
            Instantiate(factory.outSides[FloorContainer.OutsideEnum.DownLeft1], viewMap);
        downLeft1.transform.position = GetWorldPosition(-2, -2);

        GameObject downLeft2 =
            Instantiate(factory.outSides[FloorContainer.OutsideEnum.DownLeft2], viewMap);
        downLeft2.transform.position = GetWorldPosition(0, -2);

        GameObject downLeft3 =
            Instantiate(factory.outSides[FloorContainer.OutsideEnum.DownLeft3], viewMap);
    ...
    private void CreateOutSideWall()
    {
        ...
        var upWall = factory.outSides[FloorContainer.OutsideEnum.FloorUp];
        var downWall = factory.outSides[FloorContainer.OutsideEnum.FloorDown];
